...
- **기록 수정**: 인라인 편집으로 양, 약 이름, 메모 수정 (v3.1)
- **클립보드 내보내기**: 오늘 요약과 상세 기록을 복사하여 공유 (v3.1)
- **캘린더 날짜 선택**: 한국어 캘린더로 날짜 탐색 (v3.1)
...
│   ├── upload/          # 검사지 업로드
│   ├── preview/         # OCR 결과 미리보기 (날짜/병원 선택 가능)
│   ├── dashboard/       # 검사 결과 대시보드
│   ├── records-management/ # 검사 기록 관리 (병합, 삭제)
│   └── api/             # API 라우트
│       ├── daily-logs/  # 일일 기록 CRUD
│       ├── test-results/# 검사 결과 CRUD
│       │   └── merge/   # 검사 기록 병합 API (v3.1)
│       └── ...
├── components/           # React 컴포넌트
│   ├── ui/              # Shadcn/ui 기본 컴포넌트
│   │   ├── calendar.tsx # 캘린더 컴포넌트 (v3.1)
│   │   ├── checkbox.tsx # 체크박스 컴포넌트 (v3.1)
│   │   └── radio-group.tsx # 라디오 그룹 (v3.1)
